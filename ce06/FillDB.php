...
//update
    ...
    for ($i = 0; $i < sizeof($planets); $i += 2) {
        $update = "UPDATE `CSIS2440`.`Planets` SET `Active` = 'Y' WHERE ('PlanetName' = '".$planets[$i]['name']."')";
...
//search
    ...
    $search = "SELECT * FROM CSIS2440.Planets Order by PlanetName";
    ...
    echo "<table><th>Name</th><th width = '10%'>X,Y,Z</th><th>Description</th>";
